...
<head>
    <meta charset="UTF-8">
    <title>HMCT Application Form</title>
    <style>
        body {
...
<body>
    ...
    <div class="header" style="position:fixed; width:90%; top:"0px"; padding-bottom:10px;">
        ...
        <div style="text-align:center; width:100%;">
            <p style="font-size:12px; padding-bottom:10px; margin-top:2px; text-align: center;">
                Application Form for Admission to 1st Year of Diploma in Hotel Management & Catering Technology (HMCT)
        ...
        <table style="padding-top:3px; width:100%; border-collapse:collapse;">
            ...
            <tr>
                ...
                <td style="text-align: center; font-size:10px  ">
                    {{ $education->district10th->district_name ?? 'N/A' }}
                </td>
                <td style="text-align: center; font-size:10px  ">{{ $education->exam_10th_pass_yr }}</td>
                <td style="text-align: center; font-size:10px  ">{{ strtoupper($education->board10th->board_name) }}
                </td>
            ...
            <tr>
                ...
                <td style="text-align: center; font-size:10px  ">
                    {{ $education->district12th->district_name ?? 'N/A' }}
                </td>
                <td style="text-align: center; font-size:10px  ">{{ $education->exam_12th_pass_yr }}</td>
                <td style="text-align: center; font-size:10px  ">{{ strtoupper($education->board12th->board_name) }}
                </td>
